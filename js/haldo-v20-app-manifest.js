...
(function (window, document) {
    ...
    const definitions = [
...

        {
            ...
            description:
                "Verkehrs- und Sicherheitsinformationen unter
...

        {
            ...
            description:
                "Lebendige kosmische HalDo-Welt mit Sonne,
                Sternen, Planeten, subtilen Zeitmustern
                und versteckten Ebenen.",
            entry:
...

        {
            ...
            icon: "assets/logo/logo.png",
            description:
                "Sanfter, heller und schwebender
                HalDo-Systemklang.",
            entry:
